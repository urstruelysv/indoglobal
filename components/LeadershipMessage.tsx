    ...
    >
      ...
      <div className="relative max-w-[1180px] mx-auto px-5 md:px-8">
        ...
        <div className="relative">
          ...
          {/* Controls row — only shown when there are multiple leaders */}
          <div className={`flex items-center justify-between mt-14 md:mt-20 pt-6 border-t border-border/50 ${leaders.length < 2 ? 'hidden' : ''}`}>
