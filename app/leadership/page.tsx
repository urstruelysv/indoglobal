...
const leaders: Leader[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'As we lay the first stones of Indo Global School, I am moved by the passion, dedication, and faith our founding team brings each day. A school is only as strong as the relationships within it — between teachers and students, between parents and the school, and among the children themselves.',
      'At Indo Global School, learning reaches far beyond the page. We integrate global best practices with the strength of our roots. Our students study the world while remaining grounded in the values, languages, and traditions that make our community what it is.',
      'Our goal is to equip students to navigate both textbooks and the real world with confidence, kindness, and the courage to drive positive change. Every morning when children walk through our gates, we are reminded of the responsibility we carry — and the privilege it is.',
      'To our parents: thank you for the trust you have placed in us. To our students: this is your home to grow, to question, to discover, and to become the best version of yourselves.',
        ...
        <div className="relative max-w-[1180px] mx-auto px-5 md:px-8 pt-10 md:pt-14 pb-24 md:pb-32">
          ...
          >
            ...
            <p className="mt-6 md:mt-8 text-[15px] md:text-[17px] text-muted-foreground max-w-[40rem] leading-[1.75]">
              Full messages from our Chairman and Principal — on the founding belief
